...
type BillNumberResponse struct {
	...
	InfoAboutMoving  []BaseInfoAboutMoving `protobuf:"bytes,4,rep,name=info_about_moving,json=infoAboutMoving,proto3" json:"info_about_moving"`
	EtaFinalDelivery int64                 `protobuf:"varint,5,opt,name=eta_final_delivery,json=etaFinalDelivery,proto3" json:"eta_final_delivery"`
}
type ContainerNumberResponse struct {
	Container       string                `protobuf:"bytes,1,opt,name=container,proto3" json:"container"`
	ContainerSize   string                `protobuf:"bytes,2,opt,name=container_size,json=containerSize,proto3" json:"container_size"`
	Scac            string                `protobuf:"varint,3,opt,name=Scac,proto3,enum=tracking.Scac" json:"scac"`
	InfoAboutMoving []BaseInfoAboutMoving `protobuf:"bytes,4,rep,name=info_about_moving,json=infoAboutMoving,proto3" json:"info_about_moving"`
}
