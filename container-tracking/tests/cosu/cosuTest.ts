...
// }
//
// //may be fall because container info can be change
// function cosuRequestTest(cosuRequest: CosuRequest) {
//     (async () => {
//         let resp = await cosuRequest.getCosuInfoAboutMovingJson(cosuResponse.data.content.containers[0].container.containerNumber)
//         try {
//             assert.strictEqual(resp, cosuResponse)
//         } catch (e) {
//             console.log("COSU api resp not equal")
//
//         }
//     })();
// }
//
// //may be fall because container info can be change
// function cosuEtaTest(cosuRequest: CosuRequest) {
//     (async () => {
//         let resp = await cosuRequest.getEtaJson(cosuResponse.data.content.containers[0].container.containerNumber)
//         try {
//             assert.strictEqual(resp, etaApiResp)
//         } catch (e) {
//             console.log("COSU eta not equal")
//         }
//     })();
// }
//
// describe('COSU container tracking test', function () {
//     it("COSU request test", () => {
//         let cosuRequest = new CosuRequest(config.USER_AGENT_GENERATOR, config.REQUEST_SENDER)
//         cosuRequestTest(cosuRequest)
//         cosuEtaTest(cosuRequest)
//     });
//     it("COSU main class test", async () => {
//         const cosu = new CosuContainer({
