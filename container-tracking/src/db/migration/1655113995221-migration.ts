...
export class migration1655113995221 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "unlocode" ("id" SERIAL NOT NULL, "unlocode" character varying NOT NULL, "fullname" character varying NOT NULL, CONSTRAINT "PK_26fa5ecf49e498ebc5c0495d225" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "container_scac" ("id" SERIAL NOT NULL, "container" character varying NOT NULL, "scac" character varying NOT NULL, CONSTRAINT "UQ_b0dee459ca10815467c9ead1a87" UNIQUE ("container"), CONSTRAINT "PK_31e244382d66d26661accc1ff26" PRIMARY KEY ("id"))`);
